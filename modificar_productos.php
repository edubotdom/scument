...
<nav>
		<div id="enlaces">
			...
			<?php }	else { ?>			
						<a href="modificar_productos.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>"><?php echo $pagina; ?></a>
			<?php } ?>			
		</div>
...
foreach($filas as $fila) {
			...
			<article class="OBJETOS">
				...
				<form action="actualizar_producto.php" method="post" target="_blank">
				<div class="precio">
					<?php
