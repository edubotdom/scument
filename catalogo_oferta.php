...
$query = 'SELECT NOMBRE,PRECIO,ID_PRODUCTO,TIPO_IMPOSITIVO,TASA_FIJA,MARCA,FABRICANTE,PESO,FOTO_URL,DIMENSIONES,CANTIDAD_TOTAL,DESCRIPCION,PRECIO_ALQUILER' . ' FROM OBJETOS ' . "WHERE TIPO_IMPOSITIVO<0.21" . 'ORDER BY NOMBRE';
