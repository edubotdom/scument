...
<html lang="es">
	<head>
		...
		<title>SCUMENT: Alta de Usuarios</title>
	</head>
	...
	include_once ("barra_lateral.php");
		...
		<form id="alta_usuario" method="get" action="accion_alta_usuario.php" onsubmit="return validateForm()" ><!--novalidate -->
		...
		<input id="correo_electronico" name="correo_electronico" type="email" placeholder="usuario@dominio.extension" value="<?php echo $formulario['correo_electronico']; ?>" required oninput="emailValidation();"/>
		</div>
		...
		<div>
		<label for="fecha_nacimiento">Fecha de nacimiento<em>*</em>:</label>
